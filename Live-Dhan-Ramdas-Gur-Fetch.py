...
def fetch_latest_5_matching():
    ...
    for entry in root.findall("atom:entry", NS):
        ...
        # ✅ FILTER: Dhan Dhan Ramdas Gur 24x7 ONLY
        if "Dhan Dhan Ramdas Gur 24x7" not in title:
            continue
...
if __name__ == "__main__":
    ...
    print("🔄 Fetching latest Dhan Dhan Ramdas Gur 24x7 videos from RSS...")
    rss_videos = fetch_latest_5_matching()

    if not rss_videos:
        print("❌ No Dhan Dhan Ramdas Gur 24x7 video found")
        exit(0)
