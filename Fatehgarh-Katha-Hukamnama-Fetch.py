...
def fetch_latest_hukamnama_katha():
    ...
    # ✅ FILTER: Valid titles to match against
    valid_title_phrases = [
    ...
    for match in matches:
        ...
        if duration >= MIN_DURATION_SECONDS:
            ...
            print(f"⏭️ Skipping video (Duration: {duration}s < {MIN_DURATION_SECONDS}s): {vid}")
...
if __name__ == "__main__":
    ...
    if not result:
        ...
        print("🎯 Selected Fatehgarh Sahib Hukamnama/Katha:")
