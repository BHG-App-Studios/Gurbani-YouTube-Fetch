...
def fetch_latest_5_matching():
    ...
    for entry in root.findall("atom:entry", NS):
        ...
        # ✅ FILTER: Mool Mantar 24x7 ONLY
        if "Mool Mantar 24x7" not in title:
            continue
...
if __name__ == "__main__":
    ...
    print("🔄 Fetching latest Mool Mantar 24x7 videos from RSS...")
    rss_videos = fetch_latest_5_matching()

    if not rss_videos:
        print("❌ No Mool Mantar 24x7 video found")
        exit(0)
